...
function nerdech_default_news(): array {
    return [
        [
            ...
            'body' => '2026年4月30日、合同会社 nerdech の法人登記が完了しました。CareTalker の開発で培った知見を起点に、AIコンサルティング・受託開発を担う会社として始動します。',
            'link_label' => '',
            'link_url' => '',
            'published' => true,
        ],
        [
            'id' => 'business_plan_award_20260111',
            'date' => '2026-01-11',
            'display_date' => '2026.01.11',
            'title' => 'Care Talker AI が第13回 高校生ビジネスプラン・グランプリで優秀賞を受賞',
            'body' => '応募総数5,640件、639校の中からファイナリストに選出され、最終審査会で優秀賞を受賞しました。',
            'link_label' => 'official result →',
            'link_url' => 'https://www.jfc.go.jp/n/grandprix/result/13th.html',
            'published' => true,
        ],
        [
            'id' => 'business_plan_finalist_20251127',
            'date' => '2025-11-27',
            'display_date' => '2025.11.27',
            'title' => 'Care Talker AI がファイナリスト10組に選出',
            'body' => '阿南工業高等専門学校と東京工業高等専門学校の合同チームとして、過去最多応募の中からファイナリストに選ばれました。',
            'link_label' => 'school news →',
            'link_url' => 'https://www.anan-nct.ac.jp/notifications/46988/',
            'published' => true,
        ],
        [
            'id' => 'caretalker_plan_20251127',
            'date' => '2025-11-27',
            'display_date' => '2025.11.27',
            'title' => '対話型AI見守りシステム CareTalker を発表',
            'body' => '認知症高齢者の徘徊を未然に防ぐため、玄関で自然に声をかけるAIデバイスと家族向けレポートを提案しました。',
            'link_label' => 'plan summary →',
            'link_url' => 'https://www.jfc.go.jp/n/grandprix/assets/data/2026_finalist_bp05.pdf',
            'published' => true,
        ],
        [
            'id' => 'team_started_202505',
            'date' => '2025-05',
            'display_date' => '2025.05',
            'title' => '4人でチームを発足し、CareTalker の開発を始動',
            'body' => '対話型AI見守りシステム「CareTalker」の原型となる構想を立ち上げ、認知症高齢者の徘徊という社会課題に向き合う開発チームとして動き出しました。',
            'link_label' => '',
            'link_url' => '',
            'published' => true,
        ],
